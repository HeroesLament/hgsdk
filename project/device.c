...
struct hgtimer_v2 timer1 = {
    .hw      = (struct hgtimer_v2_hw *)HG_TIMER1_BASE,
    .irq_num = TIM1_IRQn,
};
#endif
#if (TIMER3_ENABLE_MS > 0)
struct hgtimer_v2 timer3 = {
    .hw      = (struct hgtimer_v2_hw *)HG_TIMER3_BASE,
    .irq_num = TIM3_IRQn,
};
#endif
...
#if (TIMER1_ENABLE_MS > 0)
    hgtimer_v2_attach(HG_TIMER1_DEVID, &timer1);
#endif
#if (TIMER3_ENABLE_MS > 0)
    hgtimer_v2_attach(HG_TIMER3_DEVID, &timer3);
#endif
